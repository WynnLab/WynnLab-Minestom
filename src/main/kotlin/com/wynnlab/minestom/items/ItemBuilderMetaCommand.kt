...
object ItemBuilderMetaCommand : Command("meta") {
    init {
    ...
    object Get : Command("get") {
        init {
            ...
            }, ArgumentType.Word("parameter").from(
                "rarity", "attack-speed", "health"
            ))
        }
    }

    object Set : Command("set") {
        init {
            //val paramArg = ArgumentType.Word("param")
        ...
        private fun getItemBuilder(sender: Player) =
